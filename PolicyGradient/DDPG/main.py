...
def main(env_id, render, num_process, lr_p, lr_v, gamma, tau, batch_size, max_iter, eval_iter,
         save_iter, log_path, model_path, seed):
    base_dir = log_path + env_id + "/DDPG_exp{}".format(seed)
    writer = SummaryWriter(base_dir)

    ddpg = DDPG(env_id, render, num_process, batch_size, lr_p, lr_v, gamma, tau, model_path, seed)
