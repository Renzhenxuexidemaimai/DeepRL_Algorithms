...
class REINFORCE:
    ...
    def _init_model(self):
        ...
        if self.model_path:
            ...
            self.policy_net.load_weights("{}/{}_reinforce_tf2".format(self.model_path, self.env_id))
    ...
    def save(self, save_path):
        ...
        self.policy_net.save_weights("{}/{}_reinforce_tf2".format(save_path, self.env_id))